...
if __name__ == "__main__":
    plaintext = raw_input("Enter plaintext: ") # any length character input
    key = int(raw_input("Enter Key: ")) # binary input of length 10
    encipher = ""
    decipher = ""
    for i in plaintext:
...
bash-4.2$ python S_DES.py
Enter plaintext: mansi
Enter Key: 50
Cipher Text: Al��d
Decipher Text: mansi
